            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="contact_hotel" name="contact_hotel" value="<?php get_input_posted('contact_hotel'); ?>" placeholder="Saisir le numéro de l'hôtel">
                    </div>
                </div>
