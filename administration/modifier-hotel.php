...
if (isset($_POST['modifhotel'])) {
    ...
    if (!empty($_POST['nom_hotel']) && !empty($_POST['pays_hotel']) && !empty($_POST['prix_chambre']) && !empty($_POST['notation_hotel']) && !empty($_POST['adresse_hotel']) && !empty($_POST['description_hotel'])) {
        ...
        elseif (!filter_var($site_web_hotel, FILTER_VALIDATE_URL)) {
            $errors[] = "Le lien du site de l'hotel n'est pas valide !";
        }
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="contact_hotel" name="contact_hotel" value="<?= (isset($_POST['contact_hotel']) ? $_POST['contact_hotel'] : $hotel->contact_hotel); ?>" placeholder="Saisir le numéro de l'hôtel">
                    </div>
                </div>
